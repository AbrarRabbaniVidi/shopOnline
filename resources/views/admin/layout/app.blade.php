                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown"
                            ...
                            <div class="nav-profile-text">
                                <p class="mb-1 text-black">Admin ONLINESHOP</p>
                            </div>
                        </a>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    <li class="nav-item nav-profile">
                        <a href="#" class="nav-link">
                            ...
                            <div class="nav-profile-text d-flex flex-column">
                                <span class="font-weight-bold mb-2">ONLINESHOP</span>
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="#ui-basic1" aria-controls="ui-basic1">
                            <span class="menu-title">Data Master</span>
                            <i class="menu-arrow"></i>
                            <i class="mdi mdi mdi-table-large menu-icon"></i>
                        </a>
                        <div class="" id="ui-basic1">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('admin.product') }}">Produk</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link "href="{{ route('admin.categories') }}">Kategori</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item ">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="#ui-basic2" aria-expanded="false" aria-controls="ui-basic2">
                            <span class="menu-title">Pengaturan</span>
                            <i class="menu-arrow"></i>
                            <i class="mdi mdi-shopping menu-icon"></i>
                        </a>
                        <div class="" id="ui-basic2">
                            <ul class="nav flex-column sub-menu">
                        ...
                        <div class="" id="ui-basic2">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{ route('laporan.barang') }}">
                                        Laporan Barang</a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('laporan.penjualan') }}">Laporan Penjualan</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2023 <a
                                href="https://www.bootstrapdash.com/" target="_blank">Online Shop</a>. All rights
                            reserved.</span>
